...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('newsletter_newsletter', 'mailing_list_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['newsletter.MailingList'], null=True))

    def backwards(self, orm):

        # Changing field 'Newsletter.mailing_list'
        db.alter_column('newsletter_newsletter', 'mailing_list_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['newsletter.MailingList']))
