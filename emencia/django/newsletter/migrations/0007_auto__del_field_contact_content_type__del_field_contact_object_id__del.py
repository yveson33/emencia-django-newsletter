...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('newsletter_contact', ['email'])

        # Deleting field 'Contact.content_type'
        db.delete_column('newsletter_contact', 'content_type_id')

        # Deleting field 'Contact.object_id'
        db.delete_column('newsletter_contact', 'object_id')


    def backwards(self, orm):
        # Adding field 'Contact.content_type'
        db.add_column('newsletter_contact', 'content_type',
        ...
        db.add_column('newsletter_contact', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Contact', fields ['email']
        db.create_unique('newsletter_contact', ['email'])
