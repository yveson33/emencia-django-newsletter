...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('newsletter_mailinglistsegment', 'position',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('newsletter_mailinglistsegment', 'position')
    ...
    models = {
        ...
        'newsletter.mailinglistsegment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mailing_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'segments'", 'to': "orm['newsletter.MailingList']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
