...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('newsletter_contact', 'owner',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'Contact', fields ['owner', 'email']
        db.create_unique('newsletter_contact', ['owner', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Contact', fields ['owner', 'email']
        db.delete_unique('newsletter_contact', ['owner', 'email'])

        # Deleting field 'Contact.owner'
        db.delete_column('newsletter_contact', 'owner')
